# football_analytics_lakehouse

The 'football_analytics_lakehouse' project was generated by using the default-sql template.
...
3. To deploy a development copy of this project, type:
    ...
    `[dev yourname] football_analytics_lakehouse_job` to your workspace.
